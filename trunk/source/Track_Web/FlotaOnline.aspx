<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FlotaOnline.aspx.cs" Inherits="Track_Web.FlotaOnline" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function () {
            ...
            var btnCargarPatentes = {
                id: 'btnCargarPatentes',
                xtype: 'button',
                iconAlign: 'left',
                icon: 'Images/upload_excel_20x20.png',
                text: 'Cargar Patentes',
                minWidth: 120,
                height: 26,
                style: {
                    marginLeft: '20px'
                ...
                listeners: {
                    click: {
                        ...
                        fn: function () {
                            ...
                            mapForm.action = 'FlotaOnline.aspx?Metodo=ExportExcel';
            ...
            var gridPosiciones = Ext.create('Ext.grid.Panel', {
                ...
                buttons: [chkMostrarTrafico, btnCargarPatentes, btnExportar, btnActualizar],
                viewConfig: {
